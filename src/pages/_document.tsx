    ...
    return (
      <Html lang="ja">
        <Head>
          ...
          <meta name="apple-mobile-web-app-title" content="Giv" />
          <link
          ...
          />
          {/* 一般 */}
          <meta name="application-name" content="Giv" />
          <meta name="theme-color" content="#000" />
          <meta name="description" content="this is Giv" />
          <link rel="icon" sizes="192x192" href="/icon-192x192.png" />
          <link rel="icon" href="/favicon.ico" />
          <link rel="manifest" href="/manifest.json" />
          <meta
            property="og:title"
            content={"Giv - 簡単に始められる技術ブログ"}
          />
